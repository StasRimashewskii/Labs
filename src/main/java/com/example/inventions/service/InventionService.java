...
public class InventionService {
  ...
  public InventionService() {
    ...
    inventions.add(new Invention(1L, "Лампочка",
            "Электрическая лампочка, изобретённая Томасом Эдисоном."));
    inventions.add(new Invention(2L, "Телефон",
            "Устройство для передачи голоса, изобретённое Александром Беллом."));
    inventions.add(new Invention(3L, "Интернет",
            "Система глобальной связи, изобретённая в 20 веке."));
  }
